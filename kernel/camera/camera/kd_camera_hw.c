...
u32 pinSet[2][8] = {
    ...
    if (On) {
			...
			(currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3H7Y_MIPI_RAW,currSensorName))))
		{
            ...
            {
		PK_DBG("andreya108: OV8825 power up VGP5 for Lenovo P780\n");
		if(TRUE != hwPowerOn(MT65XX_POWER_LDO_VGP5, VOL_1800, mode_name)) 
		{
		    PK_DBG("[CAMERA SENSOR] Fail to enable VGp5\n");
		    goto _kdCISModulePowerOn_exit_;
		}
                ...
                currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI258_MIPI_YUV_SW, currSensorName))){
    {
		  ...
		  if(TRUE != hwPowerOn(MT65XX_POWER_LDO_VGP3, VOL_1800,mode_name)) 
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
	  ...
	  else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI256_MIPI_YUV,currSensorName)))			  
	  {
		  ...
		  if(TRUE != hwPowerOn(MT65XX_POWER_LDO_VGP3, VOL_1800,mode_name)) //TODO
		   {
			   PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
			   //return -EIO;
			   goto _kdCISModulePowerOn_exit_;
    ...
    else
    {
			...
			(currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3H7Y_MIPI_RAW,currSensorName))))
		{
            ...
            if (0 == strcmp(SENSOR_DRVNAME_OV8825_MIPI_RAW,currSensorName))
            {
                PK_DBG("andreya108: OV8825 power down VGP5 for for Lenovo P780\n");
		if(TRUE != hwPowerDown(MT65XX_POWER_LDO_VGP5, mode_name)) {
		    PK_DBG("[CAMERA SENSOR] Fail to power off VGP5\n");
		    goto _kdCISModulePowerOn_exit_;
		}
            }
            else
		...
		else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K8AAYX_MIPI_YUV,currSensorName)))
		{
			...
			if(TRUE != hwPowerDown(MT65XX_POWER_LDO_VGP3, mode_name)) { //TODO
				PK_DBG("[CAMERA SENSOR] Fail to OFF digital power\n");
				//return -EIO;
				goto _kdCISModulePowerOn_exit_;
			}
