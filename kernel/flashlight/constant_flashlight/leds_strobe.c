...
#define DEBUG_LEDS_STROBE
	...
	#define PK_ERR(a,...)
#endif
#if defined(LENOVO_PROJECT_S820) ||defined(LENOVO_PROJECT_A830)||defined(LENOVO_PROJECT_PRADA) || defined(LENOVO_PROJECT_S820_ROW) || defined(LENOVO_PROJECT_PRADA_ROW)
...
#elif defined(LENOVO_PROJECT_S820)||defined(LENOVO_PROJECT_A830)||defined(LENOVO_PROJECT_PRADA) || defined(LENOVO_PROJECT_S820_ROW) || defined(LENOVO_PROJECT_PRADA_ROW)
	if(brightness == 0)
	{
		mt_set_gpio_out(FLASH_PIN,GPIO_OUT_ZERO);
		mt_set_gpio_out(TORCH_PIN,GPIO_OUT_ZERO);
