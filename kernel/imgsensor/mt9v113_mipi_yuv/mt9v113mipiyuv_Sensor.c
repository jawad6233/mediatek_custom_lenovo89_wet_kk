...
static void MT9V113MIPI_YUV_sensor_initial_setting(void)
{
    ...
    count=5;
		...
		MT9V113MIPI_write_cmos_sensor(0x0990, 0x0001);
        /* BEGIN PN: SPBB-1239 ,Modified by f00208919, 2013-02-19 */
		MT9V113MIPI_write_cmos_sensor(0x098C, 0x2717);
		MT9V113MIPI_write_cmos_sensor(0x0990, 0x0025);
        /* END PN: SPBB-1239 ,Modified by f00208919, 2013-02-19 */
...
//    pSensorInfo->SensorVerFOV = 60;
		...
		/* BEGIN PN:SPBB-1176, Modified by l00183577, 2012-11-26*/
		pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_UYVY;
		/* END PN:SPBB-1176, Modified by l00183577, 2012-11-26*/
		...
		pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_4MA; //8mA->4mA 		
        switch (ScenarioId)
		{
