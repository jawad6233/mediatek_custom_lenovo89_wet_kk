...
/* SENSOR VGA SIZE */
#define MT9V113MIPI_IMAGE_SENSOR_VGA_WIDTH					(640)
#define MT9V113MIPI_IMAGE_SENSOR_VGA_HEIGHT					(480)


/* Sensor vertical blanking & horizontal blanking, for preview and capture mode. */
#define MT9V113MIPI_DEFUALT_PREVIEW_LINE_LENGTH  0x034A  //842
#define MT9V113MIPI_DEFUALT_PREVIEW_FRAME_LENGTH 0x0206  //518
...
//Mode state
typedef enum MT9V113MIPI_CAMCO_MODE
{		
  MT9V113MIPI_CAM_PREVIEW=0,//Camera Preview
  
  MT9V113MIPI_CAM_CAPTURE,//Camera Capture

  MT9V113MIPI_VIDEO_MPEG4,//Video Mode
  MT9V113MIPI_VIDEO_MJPEG,
  
  MT9V113MIPI_WEBCAM_CAPTURE,//WebCam
  
  MT9V113MIPI_VIDEO_MAX
} MT9V113MIPI_Camco_MODE;

struct MT9V113MIPI_sensor_struct
{
	...
	//kal_bool Night_Mode;
	MT9V113MIPI_Camco_MODE Camco_mode;
...
#define MT9V113MIPI_WRITE_ID 0x7A
#define MT9V113MIPI_READ_ID 0x7B


//export functions
UINT32 MT9V113MIPIOpen(void);
UINT32 MT9V113MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution);
UINT32 MT9V113MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 MT9V113MIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 MT9V113MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
